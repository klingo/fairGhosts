...
import pacman.entries.wcci2012.pacman.r02_maastricht.MyPacMan;
...
{	
	...
	public static void main(String[] args)
	{
		...
		int delay=5;
		boolean visual=true;
		exec.runGame(new RandomPacMan(),new FairGhosts(),visual,delay);
  		 */
		
		///*
		//run the game in asynchronous mode.
		boolean visual=true;
//		exec.runGameTimed(new NearestPillPacMan(),new FairGhosts(),visual);
		exec.runGameTimed(new MyPacMan(),new FairGhosts(),visual);
//		exec.runGameTimed(new HumanController(new KeyBoardInput()),new FairGhosts(),visual);	
		...
		exec.runGameTimedSpeedOptimised(new RandomPacMan(),new FairGhosts(),fixedTime,visual);
		*/
		...
		exec.runGameTimedRecorded(new HumanController(new KeyBoardInput()),new FairGhosts(),visual,fileName);
